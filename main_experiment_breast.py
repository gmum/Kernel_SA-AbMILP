...
# dataset
parser.add_argument('--dataset_name', type=str, default='breast', metavar='N', help='name of the dataset: bags_mnist')
parser.add_argument('--dataset_size', type=int, default=58, metavar='N', help='number of images in dataset (default: 58)')
parser.add_argument('--kfold_test', type=int, default=10, metavar='k', help='number of folds (default: 10)')
parser.add_argument('--kfold_val', type=int, default=10, metavar='k', help='percentage of the train set that will be used for validation (default: 10)')
