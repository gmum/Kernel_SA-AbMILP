...
class MnistBags(data_utils.Dataset):
    ...
    def _create_bags(self):
        ...
        for i in range(self.num_bag):
            ...
            # labels_in_bag = ((self.xor_numbers[0] in labels_in_bag) & ~(self.xor_numbers[1] in labels_in_bag)) | \
            #                 ((self.xor_numbers[1] in labels_in_bag) & ~(self.xor_numbers[0] in labels_in_bag))
            # labels_in_bag = torch.sum(labels_in_bag) > 50
